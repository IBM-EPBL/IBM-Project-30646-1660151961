...
COS_API_KEY_ID="xyvXMIyy5cIn45N8kIfZjA5h_pFdj9nVk54897U0Fopf"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/4d2132cfa69a40c79e8fdaa4fc856c06:a09961b5-6182-4864-b53f-7bf682272f96::"
...
@app.route('/')
def index():
    files = get_bucket_contents('lava')
